...
public class Users {
	...
	public Users(
			...
			@Pattern(regexp = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@#$%!^&*()])[A-Za-z\\d@#$%!^&*()]{8,}$", message = "Password must have at least 1 uppercase letter, 1 lowercase letter, 1 special character, 1 numeric character, and be at least 8 characters long") @Size(min = 8, message = "Password should be greater than 8") String password,
			String role) {
		super();
